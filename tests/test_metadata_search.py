...
class MetadataSearchTests(unittest.TestCase):
    ...
    def test_openalex_projects_only_bounded_candidate_metadata(self) -> None:
        ...
        adapter._request_json = lambda *_: {"results": [{"id": "https://openalex.org/W1", "display_name": "A title", "publication_year": 2024, "open_access": {"is_oa": True}, "cited_by_count": 8, "abstract_inverted_index": {"hidden": [0]}}]}
