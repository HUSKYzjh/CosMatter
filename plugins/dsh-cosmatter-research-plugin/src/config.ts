...
export function normalizeConfig(config: CosMatterResearchConfig = {}): NormalizedConfig {
  ...
  if (!Number.isInteger(maxResponseBytes) || maxResponseBytes < 4_096 || maxResponseBytes > 524_288) throw new Error('maxResponseBytes must be an integer between 4096 and 524288')
