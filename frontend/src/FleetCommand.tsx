...
import type { DshProfileHealth, DshProfileStatus, HarnessCatalogueHealth, HarnessPluginDescriptor, OperationalTelemetry } from "./localApi";
...
import { HarnessCapabilityDeck } from "./HarnessCapabilityDeck";
...
export function FleetCommand(props: { bundle: ImportedBundle; locale: UiLocale; facilityContracts?: FacilityContractManifest[] | null; facilityCatalogueHealth?: FacilityCatalogueHealth; onRefreshFacilityContracts?: () => void; harnessPlugins?: HarnessPluginDescriptor[] | null; harnessCatalogueHealth?: HarnessCatalogueHealth; onRefreshHarnessCatalogue?: () => void; dshProfile?: DshProfileStatus | null; dshProfileHealth?: DshProfileHealth; onRefreshDshProfile?: () => void; operationalTelemetry?: OperationalTelemetry | null; bfoTemplateId?: string | null; selectedDocumentId: string | null; pdfTask: PdfTaskStatus | null; pdfTaskFreshness?: PdfTaskSnapshotFreshness; pdfTasks?: PdfTaskStatus[]; onSelectPdf?: (task: PdfTaskStatus) => void; markdownUrl: string | null; onRefreshPdf?: () => Promise<void>; onConfirmPdfDoi?: (doi: string) => Promise<void>; onExpandPdfCitations?: () => Promise<void>; onOpenTaskControl?: () => void; automaticMissionPending?: boolean; automaticCancellationRequested?: boolean; onCancelAutomaticMission?: () => Promise<void>; automaticAuthorization?: HarnessAuthorization | null; readOnlyPreview?: boolean; onExitPreview?: () => void; onNavigate: (view: View) => void }) {
  ...
  return <main class="fleet-command-stage workflow-stage">
    ...
    <Show when={counterevidenceNeeded()}>
      <section class="workflow-counterevidence-gate" aria-live="polite">
        ...
        <ActionButton class="primary-action" variant="primary" onClick={() => { if (props.onOpenTaskControl) props.onOpenTaskControl(); else props.onNavigate("discover"); }}>{counterevidence().nextAction}</ActionButton>
      </section>
    </Show>
