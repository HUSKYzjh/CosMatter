...
import type { HarnessCatalogueHealth, HarnessPluginDescriptor } from "./localApi";
...
export function FleetCommand(props: { bundle: ImportedBundle; locale: UiLocale; facilityContracts?: FacilityContractManifest[] | null; facilityCatalogueHealth?: FacilityCatalogueHealth; onRefreshFacilityContracts?: () => void; harnessPlugins?: HarnessPluginDescriptor[] | null; harnessCatalogueHealth?: HarnessCatalogueHealth; onRefreshHarnessCatalogue?: () => void; bfoTemplateId?: string | null; selectedDocumentId: string | null; pdfTask: PdfTaskStatus | null; pdfTaskFreshness?: PdfTaskSnapshotFreshness; pdfTasks?: PdfTaskStatus[]; onSelectPdf?: (task: PdfTaskStatus) => void; markdownUrl: string | null; onRefreshPdf?: () => Promise<void>; onConfirmPdfDoi?: (doi: string) => Promise<void>; onExpandPdfCitations?: () => Promise<void>; onOpenTaskControl?: () => void; automaticMissionPending?: boolean; automaticCancellationRequested?: boolean; onCancelAutomaticMission?: () => Promise<void>; automaticAuthorization?: HarnessAuthorization | null; readOnlyPreview?: boolean; onExitPreview?: () => void; onNavigate: (view: View) => void }) {
  ...
  return <main class="fleet-command-stage workflow-stage">
    ...
    <HarnessCapabilityDeck locale={props.locale} health={props.harnessCatalogueHealth ?? "disabled"} plugins={props.harnessPlugins ?? null} authorization={props.automaticAuthorization ?? null} operationPending={props.automaticMissionPending} onRefresh={props.onRefreshHarnessCatalogue} />
