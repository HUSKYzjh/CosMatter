...
export function PaperReader(props: { bundle: ImportedBundle; session: ResearchSession; pdfTask: PdfTaskStatus | null; screeningAllowsSourceReview: boolean; markdownUrl: string | null; onRecordSourceMap?: (segments: PrivateSourceMapSegment[]) => Promise<SourceMapRecordResult>; onLoadSourceMap?: () => Promise<SourceMapRecordResult>; onRecordMaterialFacts?: (facts: HumanMaterialFactInput[]) => Promise<void>; onRecordEvidence?: (input: HumanEvidenceReviewInput) => Promise<EvidenceReviewResult>; onNavigate: (view: View) => void; onSelectEvidence: (evidence: EvidenceCard) => void }) {
