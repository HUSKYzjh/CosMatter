...
2. **进行中**：四个核心 P0 问题和 7 个 v2 扩展问题均已具备“主路线 + 独立实验组 + 条件/定义反例”；磁性、光学和工艺三族已各建立第一条完整比较问题。下一步扩到 `M_s/M_r/H_c`、吸收系数/`V_oc/J_sc`、沉积速率与独立批次数，并优先使用公开论文、作者稿或校园账号本地核对，不在仓库保存受限全文。
