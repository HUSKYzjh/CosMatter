#!/usr/bin/env python3
"""Poll MinerU batch states without retrieving PDFs, Markdown, URLs, or text."""
...
SPEC = importlib.util.spec_from_file_location("cosmatter_mineru_v4_batch_poll", SOURCE)
